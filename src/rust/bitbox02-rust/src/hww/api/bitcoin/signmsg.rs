...
pub async fn process(
    ...
    let basic_info = hal.tr_format("Coin: {}", &[super::params::get(coin).name]);
    let title = hal.tr("Sign message");
    ...
    let title_long = hal.tr("Sign message");
    let title_short = hal.tr("Sign");
